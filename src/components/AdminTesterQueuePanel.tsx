...
export default function AdminTesterQueuePanel() {
  ...
  return (
    <div id="admintester-queue" className="admin-block scroll-mt-24 admin-queue" style={{ marginBottom: 16, padding: 12, border: "1px solid #e8c872", borderRadius: 8 }} key={tick}>
      <h3 style={{ marginTop: 0 }}>Pending approval requests</h3>
      <p className="hint">
        People who signed in with the shared admin password wait here until you approve them.
      </p>
      {pending.length === 0 ? (
